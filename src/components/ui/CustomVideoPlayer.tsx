  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-primary-dark/70 text-neutral-light-bg transition-colors hover:bg-primary-dark/90"
        style={{ width: "clamp(96px, 30vw, 300px)", height: "clamp(96px, 30vw, 300px)" }}
      >
