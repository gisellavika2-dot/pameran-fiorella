          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                <span className="font-sans text-gray-400">Logo {division.name}</span>
              </div>
              <div>
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[1, 2, 3].map((item) => (
                ...
                >
                  <span className="font-sans text-gray-400">Foto Divisi {item}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="text-center">
                <div className="w-32 h-32 bg-gray-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                  <span className="font-sans text-gray-400 text-sm">Foto</span>
                </div>
                <h3 className="font-serif font-bold text-lg text-primary-dark">
                  {division.coordinatorName}
                </h3>
                <p className="font-sans text-gray-600">{division.coordinatorRole}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="text-center">
                  <div className="bg-gray-200 rounded-lg h-32 flex items-center justify-center mb-2">
                    <span className="font-sans text-gray-400 text-sm">Anggota {item}</span>
                  </div>
                  <p className="font-sans text-sm text-gray-600">Nama Anggota {item}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2, 3, 4].map((item) => (
                ...
                >
                  <span className="font-sans text-gray-400">Kegiatan {item}</span>
                </div>
              ))}
            </div>
          </div>
